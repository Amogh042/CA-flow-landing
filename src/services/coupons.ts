...
// TODO: Replace the coupon modal with Razorpay checkout.
// On successful payment webhook, call the same logic as redeemCoupon()
...
export async function redeemCoupon(code: string, userId: string): Promise<RedeemResult> {
  ...
  if (!validation.valid || !validation.coupon) {
    return { valid: false, error: validation.error ?? "Invalid coupon code" };
  }
